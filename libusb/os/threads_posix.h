...
{
	__android_log_print(ANDROID_LOG_DEBUG, "libusb", "usbi_mutex_static_lock");
	PTHREAD_CHECK(pthread_mutex_lock(mutex));
}
static inline void usbi_mutex_static_unlock(usbi_mutex_static_t *mutex)
{
	__android_log_print(ANDROID_LOG_DEBUG, "libusb", "usbi_mutex_static_unlock");
...
{
	__android_log_print(ANDROID_LOG_DEBUG, "libusb", "usbi_mutex_init");
